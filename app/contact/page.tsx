...
export default function page() {
  return (
    <main className="bg-gray-100 py-10">
      <article className="max-w-3xl mx-auto pt-16 space-y-4 px-4">
      ...
      <article className="grid lg:grid-cols-3 my-20 gap-6 w-3/4 max-w-5xl mx-auto">
        <section className="md:col-span-1 p-6 bg-white rounded-lg shadow-md">
      ...
      <article className="flex flex-col md:flex-row py-20 max-w-5xl mx-auto p-6 gap-8">
        <iframe
      ...
      <article className="bg-white max-w-5xl mx-auto rounded-xl p-6 my-10">
        <h4 className="font-black text-2xl pb-4">Nuestra misión</h4>
        <p className="text-gray-500">
          En PawScout, nuestra misión es conectar a los animales necesitados con
          personas que puedan brindarles un hogar amoroso y seguro. Trabajamos
          incansablemente para rescatar, rehabilitar y encontrar familias
          responsables para cada uno de nuestros amigos peludos.
        </p>
        <section className="grid md:grid-cols-3 pt-6">
          {mision.map((item) => (
